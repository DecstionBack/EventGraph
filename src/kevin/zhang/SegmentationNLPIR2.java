...
public class SegmentationNLPIR2 {
	...
	public static void main(String[] args) throws Exception{
		...
		File file2 = new File("banama_add.txt");
		FileReader fileReader2 = new FileReader(file2);
		BufferedReader bufferedReader2 = new BufferedReader(fileReader2);
		File file3 = new File("banama_add_out.txt");
		...
		{
			LinkedList<String> linewords = Segmentation(line, null);
		...
		List<Map.Entry<String, Integer>> arrayList = new ArrayList<Map.Entry<String, Integer>>(wordscount.entrySet());
...
//			bufferedWriter.write(word + "  " + wordscount.get(word));
//			bufferedWriter.newLine();
//		}
	...
	public static LinkedList<String> Segmentation(String sInput,/*, LinkedList<String> userDict, */LinkedList<String> stopwords) throws Exception{
...
//				testNLPIR.NLPIR_AddUserWord(dict.getBytes("UTF-8"));
//			}
